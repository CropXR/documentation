...
4. **Set Permissions**: In the sharing settings, you can add users or groups by entering their email addresses. You can also set their permissions (view or edit) and add a message if needed.
